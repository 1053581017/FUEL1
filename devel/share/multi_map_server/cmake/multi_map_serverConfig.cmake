...
if("TRUE" STREQUAL "TRUE")
  set(multi_map_server_SOURCE_PREFIX /home/ykm/fuel/src/FUEL/uav_simulator/Utils/multi_map_server)
  set(multi_map_server_DEVEL_PREFIX /home/ykm/fuel/devel)
  ...
  set(multi_map_server_INSTALL_PREFIX /home/ykm/fuel/install)
...
if(NOT "/home/ykm/fuel/devel/include " STREQUAL " ")
  set(multi_map_server_INCLUDE_DIRS "")
  set(_include_dirs "/home/ykm/fuel/devel/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'multi_map_server' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ykm/fuel/src/FUEL/uav_simulator/Utils/multi_map_server/${idir}'.  ${_report}")
    endif()
