...
if("TRUE" STREQUAL "TRUE")
  set(rviz_plugins_SOURCE_PREFIX /home/ykm/fuel/src/FUEL/uav_simulator/Utils/rviz_plugins)
  set(rviz_plugins_DEVEL_PREFIX /home/ykm/fuel/devel)
  ...
  set(rviz_plugins_INSTALL_PREFIX /home/ykm/fuel/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rviz_plugins' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ykm/fuel/src/FUEL/uav_simulator/Utils/rviz_plugins/${idir}'.  ${_report}")
    endif()
